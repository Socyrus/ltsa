...
public class Symbol {
	...
	public static final int NEW_ENVIRONMENT = 3203;
	public static final int OLD_GOAL = 3204;
	public static final int NEW_GOAL = 3205;
	public static final int TRANSITION = 3206; //transition T
	public static final int UPDATE_FLUENTS = 3207;
	public static final int UPDATE_DEBUG = 3208; // debug
	public static final int UPDATE_CHECK_TRACE = 3209; //checkTrace
	public static final int GRAPH_UPDATE = 3210;
	public static final int GRAPH_INITIAL_STATE = 3211;
	public static final int GRAPH_TRANSITIONS = 3212;
	// _______________________________________________________________________________________
	// Expression symbols
	...
	static {
		...
		blueSymbols.add(UPDATE_CHECK_TRACE);
